...
const OriginWarning = () => {
  ...
  useEffect(() => {
    ...
    } else if (window.location.hostname === 'cryptocurrencydevelopers.dev' ||
        (window.location.hostname === 'cryptocurrencydevelopers.github.io')) {
      setContent('Welcome to the CryptocurrencyDevelopers Solidity IDE instance of remix-project. Feel free to use the free service. Join us on telegram at @cryptocurrencydevs @cryptocurrencydevelopers')
